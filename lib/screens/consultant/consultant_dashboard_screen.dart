...
final consultantDashboardState = ref.watch(consultantProvider);
    return Scaffold(
      ...
      body: SafeArea(
        child: consultantDashboardState.isLoading?const CustomLoader():SingleChildScrollView(
          child: Column(
            ...
            //App Bar
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: Text(consultantDashboardState.consultantData?['name']??'',
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CustomButton(
                      ...
                      onPressed: () {
                        _showFullClaimsPopup(context, consultantDashboardState.claimSummaryTableData, heading);
                      },
                    ),
              ...
              CustomTableView(
                data: consultantDashboardState.claimSummaryTableData.take(4).toList(),
                heading: heading,
              ),
              const SizedBox(height: 16),
              Padding(
        ...
        child: Row(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(consultantDashboardState.workingLogGraphData != null?"237":consultantDashboardState.workingLogGraphData!['hours_logged'].toString(),
                        style: GoogleFonts.montserrat(
                            fontSize: 14,
                  ...
                  LegendDot(
                      ...
                      label: "Hours Clocked-In: ${consultantDashboardState.workingLogGraphData!['hours_logged'].toString()}"),
                  const SizedBox(height: 8),
                  LegendDot(
                      color: const Color(0xff007BFF),
                      label: "Hours Left over : ${consultantDashboardState.workingLogGraphData!['hours_forecasted'].toString()}"),
                ],
              ),
            ),
            ...
            SizedBox(
              ...
              child: PieChart(
                dataMap: {
                  "Clocked-In": (consultantDashboardState.workingLogGraphData!['hours_logged'] ?? 0).toDouble(),
                  "Left": (consultantDashboardState.workingLogGraphData!['hours_forecasted'] ?? 0).toDouble(),
                },
  ...
  void _showFullClaimsPopup(BuildContext context, List<Map<String, dynamic>> allClaims, List<Map<String, String>> heading) {
    showGeneralDialog(
      context: context,
