  ...
  ConsultancyUserDataSource({
    ...
    _dataGridRows = consultancies.map<DataGridRow>((consultancy) {
      return DataGridRow(cells: [
        DataGridCell<String>(columnName: 'user_id', value: consultancy['user_id']),
        DataGridCell<String>(columnName: 'designation', value: consultancy['designation'].toString()),
        DataGridCell<Map<String, dynamic>>(columnName: 'actions', value: consultancy),
      ]);
    }).toList();
  }
