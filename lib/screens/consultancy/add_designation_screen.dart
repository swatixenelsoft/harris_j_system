...
class CustomAddDesignationDialog extends StatefulWidget {
  ...
  @override
  _CustomAddDesignationDialogState createState() => _CustomAddDesignationDialogState();
}

class _CustomAddDesignationDialogState extends State<CustomAddDesignationDialog> {
  String? selectedTag;
                          ...
                          onPressed: () {
                            if (_designationController.text.isNotEmpty) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Please fill in the designation name'),
                                ),
                              );
                            }
                          },
