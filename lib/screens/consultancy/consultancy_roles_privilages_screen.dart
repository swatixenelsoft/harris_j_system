...
class _DesignationRoleScreenState extends State<DesignationRoleScreen>
  ...
  final List<Map<String, dynamic>> privileges = [
    {'module': 'Consultant', 'view': false, 'add': true, 'edit': false, 'delete': false, 'print': false},
    {'module': 'Consultancy', 'view': true, 'add': true, 'edit': true, 'delete': false, 'print': true},
    {'module': 'User', 'view': true, 'add': true, 'edit': false, 'delete': true, 'print': false},
    {'module': 'System Property', 'view': true, 'add': true, 'edit': true, 'delete': false, 'print': true},
    {'module': 'Timesheet Submission', 'view': true, 'add': true, 'edit': false, 'delete': false, 'print': true},
  ];
    ...
    return FractionallySizedBox(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFFFF1901) : const Color.fromRGBO(242, 242, 242, 1),
        ...
        padding: const EdgeInsets.symmetric(vertical: 13, horizontal: 8), // Increased vertical padding
        child: Text(
          title,
          style: TextStyle(
    ...
    return Row(
      ...
      children: [
        ...
        ElevatedButton.icon(
          ...
          label: Text('Add $title', style: const TextStyle(fontFamily: 'Montserrat')),
          onPressed: onAdd,
        ),
      ],
    );
    ...
    return Column(
      children: designations.map((designation) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? const Color.fromRGBO(255, 150, 27, 0.1) : Colors.white,
                ...
                DataCell(
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isAssigned ? const Color.fromRGBO(31, 146, 84, 1) : Colors.grey.shade400,
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(width: 5, color: Colors.white, height: headerHeight),
                        ...
                        child: Column(
                          children: sortedPrivileges.asMap().entries.map((entry) {
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  _buildPermissionCell(privilege, 'view', index, rowHeight, isLast: false),
                                  Container(width: 5, color: Colors.white),
                                  _buildPermissionCell(privilege, 'add', index, rowHeight, isLast: false),
                                  Container(width: 5, color: Colors.white),
                                  _buildPermissionCell(privilege, 'edit', index, rowHeight, isLast: false),
                                  Container(width: 5, color: Colors.white),
                                  _buildPermissionCell(privilege, 'delete', index, rowHeight, isLast: false),
                                  Container(width: 5, color: Colors.white),
                                  _buildPermissionCell(privilege, 'print', index, rowHeight, isLast: true),
                                ],
                              ),
                            );
                          }).toList(),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: Colors.white,
            border: Border.all(
              color: hasPermission ? const Color(0xFF006806) : Colors.grey.shade400,
              width: 2,
            ),
          ),
          child: hasPermission
