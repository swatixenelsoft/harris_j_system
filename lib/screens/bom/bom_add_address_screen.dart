...
class BomAddAddressBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BomAddAddressBottomSheet> createState() =>
      _BomAddAddressBottomSheetState();
}

class _BomAddAddressBottomSheetState
    extends ConsumerState<BomAddAddressBottomSheet> {
