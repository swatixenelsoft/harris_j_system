...
final consultancyProvider =
    StateNotifierProvider<GetConsultancyNotifier, GetConsultancyState>((ref) {
  return GetConsultancyNotifier(ApiService());
});

class GetConsultancyState {
  ...
  GetConsultancyState copyWith({
    bool? isLoading,
    String? error,
    List<Map<String, dynamic>>? consultancyList,
  }) {
    return GetConsultancyState(
...
class GetConsultancyNotifier extends StateNotifier<GetConsultancyState> {
