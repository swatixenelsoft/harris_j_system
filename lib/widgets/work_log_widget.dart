...
context.pop({'success': true});
  ...
  void checkWorkedHours() async{
    ...
    if(workedHours>24){
      ToastHelper.showError(context, 'Only numbers 1 to 24 are allowed for working hours');
      ...
      final result = await showModalBottomSheet<Map<String, dynamic>>(
        ...
        builder: (context) {
          return Container(
              ...
              child: ExtraWorkBottomSheetContent(startValue: widget.startValue, endValue: widget.endValue, dateRange: widget.dateRange,workHour:_workedHoursController.text));
        },
      );
