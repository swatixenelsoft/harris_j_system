...
class _LeaveBottomSheetContentState
  ...
  final String claimNumber = 'CF${Random().nextInt(9000) + 1000}';

  final Map<String, String> leaveOptions = {
    'NA': 'Select Leave Type',
    'ML': 'Medical Leave (ML)',
    'PDO': 'Paid Day Off (PDO)',
    'AL': 'Annual Leave (AL)',
  ...
  void initState() {
    ...
    print('${widget.startValue},${widget.endValue}');
  }
  ...
  Future<void> _addWorkHours(date, applyOnCell, leaveType, leaveHour,
    ...
    final response = await ref
        ...
        .addTimesheetData(token!, userId.toString(), type, clientId, clientName,
            status, record,corporateEmail,reportingManagerEmail,"","", certificate);
  ...
  Future<void> _addClaim(
      ...
      otherExpense,
      selectedFile) async {
    final formattedDate = convertDate(date);
    final prefs = await SharedPreferences.getInstance();
    final token = prefs.getString('token');
    final userId = prefs.getInt('userId');
    const type = 'claims';
              ...
              child: widget.isFromClaimScreen
                  ...
                  : Column(
                      ...
                      children: [
                              ...
                              children: customLeaveType.entries.map((entry) {
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    print('selectedCustomLeaveType $selectedCustomLeaveType');
                                  },
                                  child: Container(
                        ...
                        if (selectedLeaveType == "Medical Leave (ML)" ||
                            selectedLeaveType == "Custom Leave") ...[
                              ...
                              CustomButton(
                                ...
                                onPressed: () {
                                  _addWorkHours(
                                      _dateRange,
                                      widget.dateRange,
                                      selectedLeaveType == "Medical Leave (ML)"
                                          ? 'ML'
